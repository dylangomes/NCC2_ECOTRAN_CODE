function ECOTRANdynamic_NCC2_09262022_batch(setWD,Model_name,START,END,Region,CUTI_LAT,file_code_counter,run_Treatments,switch_FoodWebScenario,switch_SubModel,switch_INITIALproduction)
...
% 2D upwelling driver
% ECOTRANphysics                  = f_ECOTRANphysics_upwelling_08222022(PHYSICSinput, 'ERD_CUTI'); % SSS specify physical flux time-series to use: 'Brink_BUI', 'NWPO3_BUI', 'ERD_BUI', 'ERD_CUTI', or 'Fake_Upwelling')
ECOTRANphysics                  = f_ECOTRANphysics_NCC2_upwelling_09042022(PHYSICSinput, 'ERD_CUTI'); % SSS specify physical flux time-series to use: 'Brink_BUI', 'NWPO3_BUI', 'ERD_BUI', 'ERD_CUTI', or 'Fake_Upwelling')
% ECOTRANphysics                  = f_ECOTRANphysics_NCC2_upwelling_09042022(PHYSICSinput, 'ERD_ZERO'); % SSS specify physical constant time-series 
% -------------------------------------------------------------------------
...
ConsumptionBudget_MC(2, looky_plgcNH4, 1)   = 0.2;
ConsumptionBudget_MC(4, looky_plgcNH4, 1)   = 0.8;
