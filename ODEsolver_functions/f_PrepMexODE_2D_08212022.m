function [AddressStruct, TrophicStruct, FuncRespStruct, PhysicsStruct] = f_PrepMexODE_2D_08212022(ODEinput)
% by Jim Ruzicka
% prepare ECOTRAN variables for using C++ ODE solver.
% pack parameters & drivers for C++ mex function
% NOTE: this is a special case function for use in 2D cross-shelf models
%
% calls:
...
%       PhysicsStruct
%
% revision date: 8-21-2022
%       8/14/2022 - added pb parameter to PhysicsStruct
...
% QQQ special case for 2D physics (to transfer benthNH4 from surface to appropriate subsurface boxes)
[PhysicsStruct.SinkLink_surface, ~]                        = f_unspoolMATRIX_04282020(ODEinput.SinkLink_surface);          % (unitless, only 0, 1, or -1); (3D matrix: num_boxes DESTINY X 1 X num_boxes SOURCE)
% *************************************************************************
